public static class LogAnalysis 
{
    ...
    public static string SubstringAfter(this string log, string delimiter) =>  log.Split(delimiter, 2)[1];
    ...
    public static string Message(this string log) => log.Split(":", 2)[1].Trim();
